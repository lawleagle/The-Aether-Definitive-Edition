...
public class AetherMoaTypes {
	...
	public static void initialization() {
		blue = register("blue", 0x7777FF, new MoaProperties(1, 0.4F));
		orange = register("orange", -0xC3D78, new MoaProperties(1, 0.6F));
		white = register("white", 0xFFFFFF, new MoaProperties(2, 0.4F));
		black = register("black", 0x222222, new MoaProperties(3, 0.4F));
	}
